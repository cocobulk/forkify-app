...
await h(e),M.render(p()),q.render(l.search)}catch(e){console.log(e)}},R=async function(e){try{T.renderSpinner(),// Upload the new recipe data
await m(e),console.log(l.recipe),E.render(l.recipe),T.renderMessage(),P.render(l.bookmarks),// Change ID in URL
window.history.pushState(null,"",`#${l.recipe.id}`),// Close form window
setTimeout(function(){T.toggleWindow()},2500)}catch(e){console.error("\uD83D\uDCA5",e),T.renderError(e.message)}};P.addHandlerRender(function(){P.render(l.bookmarks)}),E.addHandlerRender(F),E.addHandlerUpdateServings(function(e){// Update the recipe servings (in state)
g(e),E.update(l.recipe)}),E.addHandlerAddBookmark(function(){l.recipe.bookmarked?v(l.recipe.id):_(l.recipe),E.update(l.recipe),P.render(l.bookmarks)}),x.addHandlerSearch(N),q.addHandlerClick(function(e){M.render(p(e)),q.render(l.search)}),T.addHandlerUpload(R);//# sourceMappingURL=index.7e262930.js.map

//# sourceMappingURL=index.7e262930.js.map
